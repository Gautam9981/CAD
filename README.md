...
Day 25 (12/11/25)
I made some changes that make the UI look kind of similar to production CAD software, however, I haven't implemented the actual features behind it yet, still need to fix the click and drag support for the sketchpad (not sure why it isn't actually working), I intend to fix that, and provide more coloring to the UI to make it look more better
