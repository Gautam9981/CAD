...
/**
 * Radial dimension for measuring circle radius or diameter.
 * Renders a leader line from center to circumference with label.
 */
public class RadialDimension extends Dimension {
     ...
     * @param showDiameter true to show diameter, false for radius
    ...
    /**
     * Set the angle for dimension line placement
