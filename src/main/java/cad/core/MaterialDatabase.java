...
public class MaterialDatabase {
        ...
        private MaterialDatabase() {
                ...
                // Use current working directory for material database
                // Changed from user home to support portable usage and easier access
                this.dataFilePath = Paths.get("materials.json").toAbsolutePath().toString();
                // No directory creation needed as we use the current directory
        ...
        private void loadDefaultMaterials() {
                ...
                // 1. MatWeb (http://www.matweb.com/) - Density and general descriptions
                // 2. Engineering Toolbox (https://www.engineeringtoolbox.com/) - Physical
                // properties
                // 3. OpenGL Materials Database
                // (http://devernay.free.fr/cours/opengl/materials.html) - Visual coefficients
                ...
                // === PLASTICS - COMMON THERMOPLASTICS ===
