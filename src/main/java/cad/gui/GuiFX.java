...
public class GuiFX extends Application {
    ...
    private TabPane createRibbon() {
        ...
        featuresToolbar.getItems().addAll(
                ...
                createRibbonButton("Shell", "Shell Feature", e -> appendOutput("Shell not implemented")),
                createRibbonButton("Wrap", "Wrap Feature", e -> appendOutput("Wrap not implemented")),
                createRibbonButton("Draft", "Draft Feature", e -> appendOutput("Draft not implemented")));
        ...
        ribbon.getTabs().addAll(editTab, sketchTab, featuresTab, constraintsTab, evaluateTab, toolsTab);
        return ribbon;
    }
