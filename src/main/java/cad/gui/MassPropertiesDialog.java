...
public class MassPropertiesDialog extends Dialog<ButtonType> {
    ...
    private MassProperties precomputedProps;
    ...
    public MassPropertiesDialog(Sketch sketch, MassProperties props) {
        ...
        setHeaderText("Mass Properties for " + cad.core.Geometry.getPrimitiveShapeType());
    ...
    private void displayPrimitiveResults() {
        ...
        sb.append("Shape Type: ").append(cad.core.Geometry.getPrimitiveShapeType()).append("\n");
