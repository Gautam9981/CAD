...
int help(int argc, char** argv) {
    ...
    //printf("  undo                           - Undo the last sketch action\n");
    //printf("  redo                           - Redo the previously undone sketch action\n");
...
//New commands to undo and redo changes
...
/* This is a list of commands that we have currently, can only create spheres and cubes and sketches (lines, circles, and points); Currently, the only thing broken is {"undo", cmd_undo, "Undo last sketch action"},
    {"redo", cmd_redo, "Redo last undone action"}, I will add when I can fix the code */
