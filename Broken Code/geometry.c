...
int create_cube(int argc, char** argv) {
    ...
    undo_state();  // Save current cube state after setting variables
    printf("[DEBUG] undo_state called after setting Cube with size %.2f and %d divisions\n", size, divisions);
...
int create_sphere(int argc, char** argv) {
    ...
    undo_state();  // Save current sphere state after setting variables
    printf("[DEBUG] undo_state called after setting Sphere with radius %.2f and %d divisions\n", radius, divisions);
